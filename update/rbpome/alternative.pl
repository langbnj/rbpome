...
our $usage = "$0 [input file] [hc threshold]\n\n 'hc threshold': Threshold above which 'hc' is set to '1' in the table (high confidence) (AVG_IS).\n\nExample: $0 11_IS\nExample: $0 SUM_IS";
($scoretype, $hc_threshold) = args(2);

$tmp = $scoretype;
$tmp =~ s/_IS$//;

$infile = "input/jae_seong_alternative_scores/IS_ALL.from_$tmp.pairs_BL.txt";
...
while (<IN>)
{
	...
	# Rbm14	Cpsf6	13.9807816531297
	# BAG4	Sf1	12.4788732018691
	# Rbm14	dmrtb1	11.7935463566593
	# CPSF7	Rbpms	11.6702366962872
	...
	die if ($tmp_homodimer != $homodimer);
	...
	# Insert into MySQL	
	Query("INSERT INTO `$table` SET scoretype='".$scoretype."', source='".basename($infile)."', symbol1='$symbol1', symbol2='$symbol2', fullsymbol1='$fullsymbol1', fullsymbol2='$fullsymbol2', species1='$species1', species2='$species2', same_species='$same_species', avg_is='$score', homodimer='$homodimer', eclip1='$eclip1', eclip2='$eclip2', hc='$hc'");
